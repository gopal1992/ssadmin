...
//                             continue;
                       ...
                       // data units, because transform() and inverseTransform() might be in effect
                      xc = axisx.p2c(x);
                      yc = axisy.p2c(y);
                      if (xc - mouseX > maxDistance || xc - mouseX < -maxDistance ||
                          yc - mouseY > maxDistance || yc - mouseY < -maxDistance)
                             continue;
...
//                             dy = Math.abs(axisy.p2c(y) - mouseY),
                        var dx = Math.abs(xc - mouseX),
                           	dy = Math.abs(yc - mouseY),
